package fr.brangers.sociakub.client.gui.screen;
...
@OnlyIn(Dist.CLIENT)
public class SocialKubMainMenu extends Screen {
    ...
    public SocialKubMainMenu() {
        this(false);
    }

    public SocialKubMainMenu(boolean p_i51107_1_) {
